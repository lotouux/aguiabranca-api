...
public class ProjetoController {
    ...
    public ResponseEntity<TarefaDTO> atualizarTarefa(@PathVariable String id, @PathVariable Integer tarefaId,
    ...
    public ResponseEntity<Void> excluirTarefa(@PathVariable String id, @PathVariable Integer tarefaId) {
